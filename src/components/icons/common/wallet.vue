<template>
  ...
  >
    ...
    />
    <path
      d="M12 1C15.771 1 17.657 1 18.828 2.172C19.637 2.98 19.888 4.128 19.965 6M9 17H12C15.771 17 17.657 17 18.828 15.828C19.637 15.02 19.888 13.872 19.965 12M8 1C4.886 1.01 3.235 1.108 2.172 2.172C1 3.343 1 5.229 1 9C1 12.771 1 14.657 2.172 15.828C2.825 16.482 3.7 16.771 5 16.898"
      stroke="black"
      stroke-width="1.5"
      stroke-linecap="round"
    />
